...
void loop()
void loop() {
  //no funciona dentro del valor sujerido ni imprime
if (medirFotoResistencia() < 300) {
    ...
    Serial.print("No funciona por superar el limite");
    Serial.println(medirFotoResistencia());
}
